"""
This module starts the process of crawling along X websites and extract and save
his corresponding HTML without JavaScript rendered.
...
def create_dict_manifest(key, value):
    # Create the final dict key value
    dict_for_json = {}
    dict_for_json.setdefault(key, value)
...
def main(args):
    ...
    dict_manifest = create_dict_manifest("tools_ok", [])

    # Create the JSON file of the dict.
    ...
    # Instance of CrawlerProcess and get the settings of from settings.py:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
                        ...
                        help="Output filename. 2 different keys: ['stats'] and ['tools_ok']"
                        )
    ...
    # Add the argument of output's file name of log:
    parser.add_argument(
                        '-log_file_name',
                        type=str,
                        metavar="",
